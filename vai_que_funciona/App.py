...
class Application:
    def __init__(self, master=None):
        ...
        self.lblidusuario = Label(self.container2, text="codigo:", font=self.fonte, width=10)
        ...
        self.lblnome = Label(self.container3, text="Titulo:", font=self.fonte, width=10)
        ...
        self.lblemail = Label(self.container5, text="ano:", font=self.fonte, width=10)
        ...
        self.lblusuario = Label(self.container6, text="edição:", font=self.fonte, width=10)
        ...
        self.lblsenha = Label(self.container7, text="data:", font=self.fonte, width=10)
    ...
    def buscarUsuario(self):
        ...
        self.txtidusuario.delete(0, END)
        self.txtidusuario.insert(INSERT, user.codigo_livro)

        self.txtnome.delete(0, END)
        self.txtnome.insert(INSERT, user.nome_do_livro)

        self.txttelefone.delete(0, END)
        self.txttelefone.insert(INSERT, user.nome_do_autor)

        self.txtemail.delete(0, END)
        self.txtemail.insert(INSERT, user.ano)

        self.txtusuario.delete(0, END)
        self.txtusuario.insert(INSERT, user.edicao)

        self.txtsenha.delete(0, END)
        self.txtsenha.insert(INSERT, user.data_de_indexacao)
