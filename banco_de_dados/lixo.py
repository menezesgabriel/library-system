...
class Livro2:
    ...
    def salvar(self):
        ...
        c.execute(
            "INSERT  INTO livros(data_de_indexacao,codigo_livro,nome_do_livro,nome_do_autor,ano,edicao) VALUES (?,?,?,?)",
            (data_de_indexacao, codigo_livro, nome_do_livro, nome_do_autor, ano, edicao))
        connection.commit()
        c.close()
        connection.close()
    ...
    def tela(self):
        ...
        bt=Button
        botao_confirmar=bt(janela,width=18, text="Salvar")
